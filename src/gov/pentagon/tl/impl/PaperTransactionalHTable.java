...
@Deprecated
public class PaperTransactionalHTable extends HTable implements TransactionalHTableInterface {
	...
	public PaperTransactionalHTable(byte[] tableName, HConnection connection, ExecutorService pool) throws IOException {
		super(tableName, connection, pool);
		init();
	}

	public PaperTransactionalHTable(byte[] tableName) throws IOException {
		super(tableName);
		init();
	}

	public PaperTransactionalHTable(Configuration conf, byte[] tableName) throws IOException {
		super(conf, tableName);
		init();
	}

	public PaperTransactionalHTable(Configuration conf, String tableName) throws IOException {
		super(conf, tableName);
		init();
	}

	public PaperTransactionalHTable(String tableName) throws IOException {
		super(tableName);
		init();
	}
}
